...
dbWriteTable(con, "state_labor_participation_rate", state_labor_participation, OVERWRITE = TRUE, append = TRUE,row.names =FALSE)

## test that data is live
data_test <- dbGetQuery(con, "SELECT * FROM state_labor_participation_rate")
rm(data_test)
